...
@class DTXConnection, DVTDisallowFinishToken, DVTObservingToken, IDEConsoleAdaptor, IDETestingDiagnosticLogArbiter, NSArray, NSDateFormatter, NSMutableArray, NSMutableDictionary, NSMutableSet, NSMutableString, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSOutputStream, NSString, NSTimer;
