...
@class DVTFileDataType, DVTFilePath, IDEActivityLogSection, IDEBuildOperation, IDEBuildParameters, IDEExecutionEnvironment, IDERunDestination, IDERunnable, IDETestOperationsObserver, NSArray, NSDictionary, NSMutableArray, NSMutableSet, NSSet, NSString;
