...
@class DVTDelayedInvocation, DVTFilePath, DVTNotificationToken, DVTObservingToken, DVTStackBacktrace, DVTTimeSlicedMainThreadWorkQueue, IDELogStore, IDETestOperationsObserver, IDEWorkspace, NSArray, NSCountedSet, NSMapTable, NSMutableArray, NSMutableDictionary, NSMutableSet, NSSet, NSString;
