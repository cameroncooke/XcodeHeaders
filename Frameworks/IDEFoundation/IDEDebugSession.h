...
@class DVTDispatchLock, DVTMutableOrderedDictionary, DVTObservingToken, DVTStackBacktrace, DVTTextDocumentLocation, IDEBreakpointManager, IDEConsoleAdaptor, IDEDebugProcess, IDELaunchSession, IDERunOperationWorker, NSArray, NSDate, NSDictionary, NSMapTable, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString;
