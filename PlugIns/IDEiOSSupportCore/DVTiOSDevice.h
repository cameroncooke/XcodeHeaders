...
#import "DVTDeviceApplicationInstaller.h"
...
- (id)platform;
- (BOOL)shouldWriteTestConfigurationToTestBundleResourceDir;
...
- (id)_updatedTestingEnvironmentVariables:(id)arg1 forApplication:(id)arg2 withTestConfiguration:(id)arg3 error:(id *)arg4;
- (BOOL)_updateTestConfiguration:(id)arg1 atPath:(id)arg2 forApplication:(id)arg3 error:(id *)arg4;
