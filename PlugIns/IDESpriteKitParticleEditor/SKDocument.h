...
@class GTFActionTimelineModel, GTFMutableObjectDictionary, IDEWorkspaceDocument, NSArray, NSMutableSet, NSObject<OS_dispatch_queue>, NSString, SKDocumentEditor, SKWorkspaceBundle;
