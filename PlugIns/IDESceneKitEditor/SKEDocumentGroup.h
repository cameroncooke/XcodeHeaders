...
#import "SKEDocumentMember.h"

@class DVTDocumentLocation, DVTFileDataType, IDEEditorDocument<SKEDocumentProtocol>, IDEFileReference, IDETypeIdentifier, NSArray, NSImage, NSString, SKEDocumentLocation, SKESceneDocument;
