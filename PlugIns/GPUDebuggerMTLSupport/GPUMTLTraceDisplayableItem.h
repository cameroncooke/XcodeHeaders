...
@property(readonly, nonatomic) BOOL hasStateMirror; // @dynamic hasStateMirror;
@property(readonly, nonatomic) id <DYPMTLStateMirror> stateMirror; // @dynamic stateMirror;
