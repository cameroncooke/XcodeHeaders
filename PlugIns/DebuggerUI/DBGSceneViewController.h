...
@interface DBGSceneViewController : NSViewController <SCNSceneRendererDelegate, DBGInteractiveSceneViewDelegate, DBGSceneCameraDelegate, DBGRangeSliderDelegate, DVTStatefulObject, DVTInvalidation>
{
