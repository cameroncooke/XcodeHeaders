...
#import "DYPDebuggerControllerProxyDelegate.h"
#import "DYShaderProfilerDelegate.h"
...
@interface GPUDebuggerController : NSObject <DVTInvalidation, DYShaderProfilerDelegate, DYPDebuggerControllerProxyDelegate>
{
