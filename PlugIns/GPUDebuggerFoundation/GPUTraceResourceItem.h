...
@interface GPUTraceResourceItem : GPUTraceOutlineItem <DYPResourceItem>
{
...
@property(readonly, nonatomic) unsigned int functionIndex; // @dynamic functionIndex;
...
- (id)initWithController:(id)arg1 parent:(id)arg2 objectID:(unsigned long long)arg3 stateMirrorObject:(const void *)arg4 containerID:(unsigned long long)arg5 sharegroupID:(unsigned long long)arg6 label:(id)arg7 type:(unsigned int)arg8;
