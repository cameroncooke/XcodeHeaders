...
@class DVTObservingToken, NSArray, NSButton, NSImage, NSPopUpButton, NSTextField, NSView, XCSUIAccountReachabilityToImageTransformer, XCSUIBotDefinitionContext;
